...
export const roleFocus = [
  "AI/ML Engineer (LLM systems and optimization)",
  "Applied Multimodal / Computer Vision Engineer",
  "Full-Stack Engineer for AI-enabled products",
  "C++/Simulation Engineer for geometry-sensitive workflows",
];
